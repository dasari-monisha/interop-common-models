...
public class Originator {
    ...
    @Column(name = "product_originator_id")
    private Integer productOriginatorId;
    ...
    public Integer getProductOriginatorId() {
        return productOriginatorId;
    }

    public void setProductOriginatorId(Integer productOriginatorId) {
        this.productOriginatorId = productOriginatorId;
    }
